...
export default function Board() {
  ...
  const { setStrokeColor, setStrokeWidth, strokeColor, strokeWidth } =
    useStore();
  ...
  function printRectangle(
    ...
    if (shape.type === "rectangle") {
      roughCanvas.rectangle(shape.x, shape.y, shape.width!, shape.height!, {
        roughness: 1,
  ...
  return (
    <div onPointerMove={cursorMovement} onPointerLeave={cursorLeave}>
      ...
      <div className="w-2/3 flex justify-around toolbar shadow-2xl shadow-black rounded-lg">
        <button onClick={setTypeRect} className="toolbar-button">
          <MdOutlineRectangle size={24} />
        </button>
        <button onClick={setTypeLine} className="toolbar-button">
          <FaSlash size={24} />
        </button>
        <button onClick={setPen} className="toolbar-button">
          <HiOutlinePaintBrush size={24} />
        </button>
        <button onClick={setSelection} className="toolbar-button">
          <FaRegHandPaper size={24} />
        </button>
        <button onClick={clearRect} className="toolbar-button">
        ...
        <button onClick={addComment} className="toolbar-button">
      ...
      <div className=" absolute top-3 w-full roomID text-black  flex justify-between ">
        ...
        <button onClick={LeaveRoom} className="m-2 py-2 w-40 bg-red-300">
          Leave Room
        </button>
      </div>
